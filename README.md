...
## Project info
**PROD-URL**: https://ortho-assist-app.lovable.app
**DEV-URL**: https://lovable.dev/projects/b0a4c070-4369-45f9-8895-0ffca49b6086
...
**Telephony & AI Agent:** [LiveKit (Cartesia)](https://cartesia.ai)
...
When a patient calls through **LiveKit**, the agent:
...
* The recorded data and appointment details are put to supabase diectly after parsing it with OpenAI. The appointment status is set to 'pending'
...
Appointment scheduling
   ↓
LiveKit → push to Supabase (status: pending)
   ↓
Lovable app → approval / decline (status is changed accordingly)
   ↓
n8n / Twilio → notify patient
